function [Y, T, dt, err] = RK1(func, dt, dtmin, dtmax, tol, y, t)
% First order Runge Kutta explicit step, for use in an IMEX algorithm.
% Uses an Euler first order and midpoint second order scheme.
% Adaptive time stepping provided by the second order method.
