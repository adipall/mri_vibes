% function [Mele,Mass] = soli8ma(ex,ey,ez,ep,rho,c)
%
%--------------------------------------------------------------------------
% This is a function to calculate the mass matrix of an acoustic brick element. 
%
...
%     N2(3,3:3:24)  =N(i,:);
    ...
    Mele = Mele + N(i,:)'*N(i,:)*detJ*wp(i);
    Mass = Mass + detJ*wp(i)*rho;
